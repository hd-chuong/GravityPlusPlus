                        ...
                        <Button 
                            ...
                            onClick={() => this.props.handleSubmit(
                                this.joinNodeName.value,
                                {
                                    ...
                                    name: this.props.datasets.filter((dataset) => dataset.id === this.state.dataset1)[0].data.label
                                },
                                {
                                    id: this.state.dataset2, 
                                    attribute: this.state.attribute2,
                                    headers: this.state.headers2,
                                    name: this.props.datasets.filter((dataset) => dataset.id === this.state.dataset2)[0].data.label
                                },
                                this.state.joinType
                                )}>
                            Add Node
