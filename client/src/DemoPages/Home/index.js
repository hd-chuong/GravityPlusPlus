...
class Home extends React.Component {
    ...
    handleUpload(event) {
        ...
        return axios({
            url: 'http://118.138.246.151:7473/app',
            ...
            return axios({
                url: `http://118.138.246.151:7473/app/${this.state.newProjName}`,
                withCredentials: true,
                method: 'post',
                data: {
    ...
    loadProject(name)
    {
        ...
        return axios({
            url: `http://118.138.246.151:7473/app/${name}`,
            withCredentials: true,
            method: 'get'
        }).then(response => {
    ...
    {
        return axios({
            url: `http://118.138.246.151:7473/app/${projectName}`,
            withCredentials: true,
            method: 'delete'
        }).then(() => {
